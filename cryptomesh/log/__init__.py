...
class Log(logging.Logger):
    ...
    def __init__(self,
                ...
                name: str = "cryptomesh",
                level: int = getattr(logging, config.CRYPTOMESH_LOG_LEVEL.upper(), logging.DEBUG),
                path: str = config.CRYPTOMESH_LOG_PATH,
                disabled: bool = False,
                ...
                error_log: bool = config.CRYPTOMESH_LOG_ERROR_FILE,
                filename: Option[str] = NONE,
                output_path: Option[str] = NONE,
                error_output_path: Option[str] = NONE,
                create_folder: bool = True,
                to_file: bool = config.CRYPTOMESH_LOG_TO_FILE,
                when: str = config.CRYPTOMESH_LOG_ROTATION_WHEN,
                interval: int = config.CRYPTOMESH_LOG_ROTATION_INTERVAL,
                 ):
        """
